...
export function DokumentasiLinkSection() {
    return (
        <div className={`${styles.wrapper} mb-16`}>
            <section className={`${styles.innerContainer} relative h-96 flex items-center justify-center`}>
                <Link to='/dokumentasi' className='group text-accent-blue rounded-2xl hover:rounded-3xl transition-all duration-300 border-2 border-current'>
                    <div className='m-1 group-hover:m-3 transition-all duration-300 flex bg-white bg-opacity-90 group-hover:bg-opacity-100 rounded-2xl'>
                        <span className='block px-8 py-6 font-display font-bold uppercase text-xl'>Lihat<br />dokumentasi</span>
                ...
                <div className='absolute left-0 top-0 w-full h-full -z-1'>
                    ...
                    <img src={img6} alt='Background' className='w-full h-full object-cover object-center' />
                </div>
            </section>
        </div>
    );
